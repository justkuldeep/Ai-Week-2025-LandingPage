...
const Timeline = () => {
  ...
  const schedule = [
    ...
    },
    {
      ...
      description: 'Exploring GenAI, GPT models, and prompt engineering',
      topics: ['GenAI Concepts', 'Large Language Models', 'Prompt Engineering'],
      icon: Sparkles,
      time: '9:00 AM - 5:00 PM',
    },
    {
      day: 6,
      date: 'Dec 17',
      title: 'Project Day & Closing',
      description: 'Build your own AI project and present to peers',
      topics: ['Hands-on Project', 'Presentations', 'Certificates'],
      icon: Trophy,
